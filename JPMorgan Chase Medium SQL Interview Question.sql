-- JPMorgan Chase SQL Interview Question: Card Launch Success
--
...
SELECT
  ...
  issued_amount
FROM cte
WHERE rn = 1               -- Only select the launch month for each card
ORDER BY issued_amount DESC;  -- Sort by largest issued_amount
